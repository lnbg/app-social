...
<html lang="{{ app()->getLocale() }}">
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            <header class="main-header">
                ...
                <a href="index2.html" class="logo">
                    ...
                    <span class="logo-mini"><b>Kols</b></span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg"><b>Kols</b>.imediavn</span>
                </a>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2014-2016 <a href="https://bestadset.com">imediavn</a>.</strong> All rights
            reserved.
        </footer>
